...
for(i in 1:length(seed)){
  for(j in 1:10){ #length of the sim in each seed
    ...
    Historical.Boot <- read.csv(paste0("~/STAT - Research/Extremes Project/Final Paper/DataApp_CI/DataApp_Historical_Boot_",seed[i],".csv"))
    Future.Boot <- read.csv(paste0("~/STAT - Research/Extremes Project/Final Paper/DataApp_CI/DataApp_Future_Boot_",seed[i],".csv"))
...
heatmap2(lat= loc.krig$lat, lon=loc.krig$lon, data=loc.krig$var1.pred,
         mainTitle = "Location")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_Loc.png", width = 6, height = 5.25)

heatmap2(lat= scale.krig$lat, lon=scale.krig$lon, data=scale.krig$var1.pred,
         mainTitle = "Scale")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_Scale.png", width = 6, height = 5.25)

heatmap2(lat= shape.krig$lat, lon=shape.krig$lon, data=shape.krig$var1.pred,
         mainTitle = "Shape")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_Shape.png", width = 6, height = 5.25)

heatmap2(lat= RL20.krig$lat, lon=RL20.krig$lon, data=RL20.krig$var1.pred,
         mainTitle = "20-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_RL20.png", width = 6, height = 5.25)

heatmap2(lat= RL50.krig$lat, lon=RL50.krig$lon, data=RL50.krig$var1.pred,
         mainTitle = "50-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_RL50.png", width = 6, height = 5.25)

heatmap2(lat= RL100.krig$lat, lon=RL100.krig$lon, data=RL100.krig$var1.pred,
         mainTitle = "100-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Boot_RL100.png", width = 6, height = 5.25)
...
heatmap2(lat= loc.krig2$lat, lon=loc.krig2$lon, data=loc.krig2$var1.pred,
         mainTitle = "Location")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_Loc.png", width = 6, height = 5.25)

heatmap2(lat= scale.krig2$lat, lon=scale.krig2$lon, data=scale.krig2$var1.pred,
         mainTitle = "Scale")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_Scale.png", width = 6, height = 5.25)

heatmap2(lat= shape.krig2$lat, lon=shape.krig2$lon, data=shape.krig2$var1.pred,
         mainTitle = "Shape")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_Shape.png", width = 6, height = 5.25)

heatmap2(lat= RL20.krig2$lat, lon=RL20.krig2$lon, data=RL20.krig2$var1.pred,
         mainTitle = "20-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_RL20.png", width = 6, height = 5.25)

heatmap2(lat= RL50.krig2$lat, lon=RL50.krig2$lon, data=RL50.krig2$var1.pred,
         mainTitle = "50-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_RL50.png", width = 6, height = 5.25)

heatmap2(lat= RL100.krig2$lat, lon=RL100.krig2$lon, data=RL100.krig2$var1.pred, 
         mainTitle = "100-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Boot_RL100.png", width = 6, height = 5.25)
