...
load("~/STAT - Research/Extremes Project/Final Paper/precip.RData")

##Bring in data
data.ridge <- read.csv("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/Ridge_Final_DataApp_Historical.csv")
data2.ridge <- read.csv("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/Ridge_Final_DataApp_Future.csv")
...
data.lasso <- read.csv("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/Lasso_Final_DataApp_Historical.csv")
...
heatmap2(lat= loc.krig$lat, lon=loc.krig$lon, data=loc.krig$var1.pred,
         mainTitle = "Location")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_Loc.png", width = 6, height = 5.25)

heatmap2(lat= scale.krig$lat, lon=scale.krig$lon, data=scale.krig$var1.pred,
         mainTitle = "Scale")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_Scale.png", width = 6, height = 5.25)

heatmap2(lat= shape.krig$lat, lon=shape.krig$lon, data=shape.krig$var1.pred,
         mainTitle = "Shape")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_Shape.png", width = 6, height = 5.25)

heatmap2(lat= RL20.krig$lat, lon=RL20.krig$lon, data=RL20.krig$var1.pred,
         mainTitle = "20-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_RL20.png", width = 6, height = 5.25)

heatmap2(lat= RL50.krig$lat, lon=RL50.krig$lon, data=RL50.krig$var1.pred,
         mainTitle = "50-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_RL50.png", width = 6, height = 5.25)

heatmap2(lat= RL100.krig$lat, lon=RL100.krig$lon, data=RL100.krig$var1.pred,
         mainTitle = "100-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp1_Ridge_RL100.png", width = 6, height = 5.25)
...
data2.lasso <- read.csv("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/Lasso_Final_DataApp_Future.csv")
...
tmp <- cbind(Grid.Loc.Dif, Grid.Scale.Dif, Grid.Shape.Dif, Grid.RL20.Dif)
##RIDGE PLOTS
heatmap2(lat= loc.krig$lat, lon=loc.krig$lon, data=Grid.Loc.Dif,
         mainTitle = "Location")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_Loc.png", width = 6, height = 5.25)

heatmap2(lat= scale.krig$lat, lon=scale.krig$lon, data=Grid.Scale.Dif,
         mainTitle = "Scale")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_Scale.png", width = 6, height = 5.25)

heatmap2(lat= shape.krig$lat, lon=shape.krig$lon, data=Grid.Shape.Dif,
         mainTitle = "Shape")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_Shape.png", width = 6, height = 5.25)

heatmap2(lat= RL20.krig$lat, lon=RL20.krig$lon, data=Grid.RL20.Dif,
         mainTitle = "20-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_RL20.png", width = 6, height = 5.25)

heatmap2(lat= RL50.krig$lat, lon=RL50.krig$lon, data=Grid.RL50.Dif,
         mainTitle = "50-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_RL50.png", width = 6, height = 5.25)

heatmap2(lat= RL100.krig$lat, lon=RL100.krig$lon, data=Grid.RL100.Dif,
         mainTitle = "100-year Return Level")
ggsave("~/STAT - Research/Extremes Project/Final Paper/DataApp_Results/HeatMap_DataApp3_Ridge_RL100.png", width = 6, height = 5.25)
