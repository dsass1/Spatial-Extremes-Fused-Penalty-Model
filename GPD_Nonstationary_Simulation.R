...
for(ss in 1:sim){
  ...
  write.csv(data, paste0("GPD_NonStationary_Data_",seed,"_",ss,".csv"))
...
write.csv(tmp, paste0("GPD_NonStationary_Results_",seed,".csv"))


write.csv(scale.val, paste0("GPD_NonStationary_Scale_",seed,".csv"))
write.csv(shape.val, paste0("GPD_NonStationary_Shape_",seed,".csv"))
write.csv(coordinates, paste0("GPD_NonStationary_Coordinates_",seed,".csv"))