...
avgRL20 <- c(mean(gev_data$MSE.RL20.Spat), mean(gev_max$MSE.RL20.Max), mean(gev_data$MSE.RL20.Ridge),mean(gev_data$MSE.RL20.Lasso), mean(gev_data$MSE.RL20.Bayes))
...
ggsave("~/Danielle/STAT - Research/Extremes Project/Final Paper/BoxPlots/BoxPlot_SimGEV_RL20.png", width = 4, height = 6)
...
avgRL20 <- c(mean(nonstat_data2$MSE.RL20.Spat), mean(nonstat_data2$MSE.RL20.Spat2),mean(nonstat_data2$MSE.RL20.Max),mean(nonstat_data2$MSE.RL20.Ridge),mean(nonstat_data2$MSE.RL20.Lasso),mean(nonstat_data2$MSE.RL20.Bayes))
...
ggplot(gev_plot_data, aes(x=Model, y=RootRL20))+
  ...
  theme(axis.text.y = element_text(size=15))+
  labs(title="20-year Return Level", y="RMSE", x= NULL)
ggsave("~/Danielle/STAT - Research/Extremes Project/Final Paper/BoxPlots/BoxPlot_NonStationary_RL20.png", width = 4, height = 6)
